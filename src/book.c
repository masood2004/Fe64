// ============================================ \\
//       FE64 CHESS ENGINE - OPENING BOOK       \\
...
typedef struct
{
    ...
    int move;   // Encoded move (polyglot format)
    int weight; // How often to play this move
    int learn;  // Learning data
} PolyglotEntry;
...
const U64 polyglot_random64[781] = {
    ...
    0x1BDEA12E35F6A8C9ULL, 0x53C065C6C8E63528ULL, 0xE34A1D250E7A8D6BULL, 0xD6B6D0ECC617C699ULL,
